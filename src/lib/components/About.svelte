  ...
  <div class="container mx-auto px-4">
    ...
    >
      ...
      <div class="max-w-4xl mx-auto">
        <div
          class="bg-white dark:bg-gray-900 rounded-xl shadow-xl p-6 sm:p-8 transition-colors duration-300"
        >
          <div class="flex flex-col md:flex-row gap-6 sm:gap-8 items-center">
            {#if personal.profileImage}
              <img
                ...
                class="w-32 h-32 sm:w-48 sm:h-48 rounded-full object-cover ring-4 ring-base-200 dark:ring-base-300 shrink-0"
                loading="lazy"
              />
            {:else}
              <div
                class="w-32 h-32 sm:w-48 sm:h-48 bg-gradient-to-br from-blue-500 to-purple-500 rounded-full flex items-center justify-center text-white text-4xl sm:text-6xl font-bold shrink-0"
              >
            ...
            <div class="flex-1">
              <h3
                class="text-xl sm:text-2xl font-bold text-gray-900 dark:text-white mb-4"
              >
                {personal.title}
              </h3>
              {#each personal.bio as paragraph}
                <p
                  class="text-sm sm:text-base text-gray-600 dark:text-gray-300 mb-4 leading-relaxed"
                >
                  {paragraph}
                </p>
              {/each}
          ...
          >
            ...
            <div
              class="text-center p-3 sm:p-4 bg-gray-50 dark:bg-gray-800 rounded-lg"
            >
              <div class="text-2xl sm:text-3xl font-bold text-pink-500">
                {stats.learning}
              </div>
              <div
                class="text-xs sm:text-sm text-gray-600 dark:text-gray-400 mt-1"
