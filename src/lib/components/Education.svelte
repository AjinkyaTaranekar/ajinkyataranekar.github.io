          ...
          >
            ...
            >
              <div class="flex-1 w-full">
                ...
                <p
                  class="text-base sm:text-lg text-blue-600 dark:text-blue-400 font-semibold mb-1 ml-13"
                >
                  {edu.institution}
                </p>
                ...
                {#if edu.location}
                  <div
                    class="flex items-center text-sm text-gray-600 dark:text-gray-400 mb-2 ml-13"
                  >
                    <svg
                      class="w-4 h-4 mr-1"
                      fill="none"
