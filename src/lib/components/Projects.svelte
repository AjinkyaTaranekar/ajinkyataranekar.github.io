    ...
    >
      ...
      >
        {#each projects as project, i}
          <div
            class="bg-white dark:bg-gray-900 rounded-xl shadow-lg overflow-hidden transition-all duration-300 hover:shadow-2xl hover:-translate-y-2 {project.featured
              ? 'md:col-span-2'
              : ''}"
            ...
            <div class={project.featured ? "md:flex" : ""}>
              <div
                class="relative {project.featured
                  ? 'md:w-1/2'
                  : 'w-full'} h-48 sm:h-64 overflow-hidden"
              >
                <img
                  src={project.image}
                  alt={project.title}
                ...
                <div class="flex flex-wrap gap-3 sm:gap-4">
                  {#if project.github}
                    <a
                      ...
                      class="flex items-center gap-2 px-3 sm:px-4 py-2 bg-gray-900 dark:bg-gray-700 text-white rounded-lg hover:bg-gray-800 transition-colors text-sm"
                    >
                      <svg
                  ...
                  {#if project.demo}
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      class="flex items-center gap-2 px-3 sm:px-4 py-2 bg-blue-500 text-white rounded-lg hover:bg-blue-600 transition-colors text-sm"
                    >
                      <svg
                        class="w-4 h-4 sm:w-5 sm:h-5"
                        fill="none"
                  ...
                  {#if project.report}
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      class="flex items-center gap-2 px-3 sm:px-4 py-2 bg-green-500 text-white rounded-lg hover:bg-green-600 transition-colors text-sm"
                    >
