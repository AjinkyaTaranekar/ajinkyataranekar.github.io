...
<section id="projects" class="py-12 sm:py-20 bg-gray-50 dark:bg-gray-800 transition-colors duration-300">
				...
				{#each projects as project, i}
					...
					>
						<div class="{project.featured ? 'md:flex' : ''}">
							<div class="relative {project.featured ? 'md:w-1/2' : 'w-full'} h-48 sm:h-64 overflow-hidden">
								<img
									src={project.image}
									alt={project.title}
