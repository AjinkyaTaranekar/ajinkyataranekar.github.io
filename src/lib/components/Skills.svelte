...
<section id="skills" class="py-12 sm:py-20 bg-base-200 transition-colors duration-300">
	<div class="container mx-auto px-4">
		<div class="transform transition-all duration-1000 {visible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}">
			...
			<p class="text-center text-sm sm:text-base text-base-content/70 mb-8 sm:mb-12 max-w-2xl mx-auto px-4">
				Technologies and tools I work with, organized by experience and practical application.
			</p>
						...
						<div class="card-body">
							...
							<div class="flex flex-wrap gap-3">
								{#each category.skills as skill}
									...
									<div class="tooltip tooltip-top" data-tip="{years} experience">
										<div class="flex flex-col gap-1 px-4 py-2 bg-base-200 rounded-lg hover:scale-105 transition-transform duration-200 cursor-pointer">
											<span class="text-sm sm:text-base font-semibold text-base-content">
												{skill.name}
											</span>
			...
			<div class="mt-8 sm:mt-12 max-w-6xl mx-auto">
				<h3 class="text-xl sm:text-2xl font-bold text-center text-base-content mb-6 sm:mb-8">
					Technologies & Tools
				</h3>
				<div class="flex flex-wrap justify-center gap-2 sm:gap-3">
					{#each additionalSkills as tech}
						<span
							class="badge badge-lg badge-outline hover:badge-primary transition-all duration-300 hover:scale-105 cursor-pointer"
						>
							{tech}
						</span>
					{/each}
